package com.chg.yuaicodemother.langgraph4j.workflow;
...
import com.chg.yuaicodemother.langgraph4j.node.*;
    ...
    public CompiledGraph<MessagesState<String>> createWorkflow() {
        try {
            return new MessagesStateGraph<String>()
                    ...
                    .addNode("code_quality_checker", CodeQualityCheckNode.create())
                    ...
                    .addConditionalEdges("code_quality_checker",
                            edge_async(this::routeAfterQualityCheck),
                            Map.of(
                                    "build", "project_builder", // 质检通过，需要构建
                                    "skip_build", END, // 质检通过，无需构建
                                    "fail", "code_generator" // 质检失败，修改代码
