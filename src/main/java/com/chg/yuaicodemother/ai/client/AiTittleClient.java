...
import com.chg.yuaicodemother.ai.config.AiTittleProperties;
...
public class AiTittleClient {

    private final AiTittleProperties properties;

    public String getAiTitle(String prompt) {
        ...
        return jsonObject.getStr("title");
